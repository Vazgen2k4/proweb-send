...
abstract class AppColors {
  ...
  static const Color akcent = Color(0xff64d2ff);
  static const Color akcentLight = Color(0xff5ac8fa);

  static const Color akcentSecondary = Color(0xff64d2ff);
  static const Color akcentSecondaryLight = Color(0xff0a84ff);
  ...
  static const Color textInfo = Color(0xff8e8e93);
  static const Color textInfoLight = Color(0xff000000);
